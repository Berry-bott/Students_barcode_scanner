...
//       setCameraDevices(devices);
//       if (devices.length > 0) {
//         setSelectedCameraId(devices[0].id); // default
//       }
//     });
//   }, []);
...
//       if (studentError || !student) {
//         setStatusMsg(`❌ Student with reg_num "${regNum}" not found`);
//         return;
//       }
...
//         reg_num: regNum,
//         status: "present", // optional because it's default
//       });

//       if (attendanceError) {
//         setStatusMsg(`⚠️ Could not log attendance: ${attendanceError.message}`);
//       } else {
//         setStatusMsg(`✅ Attendance recorded for ${regNum}`);
//       }
//     } catch (err) {
//       setStatusMsg("🚫 Unexpected error while scanning.");
//     }
//   };
...
//       .catch((err) => {
//         console.error("Failed to start camera:", err);
//         setStatusMsg("❌ Failed to start scanner");
//       });
//   };
...
//       {/* Status Message */}
//       {statusMsg && (
//         <div className="fixed bottom-0 w-full text-center py-2 text-white bg-black bg-opacity-70">
//           {statusMsg}
//         </div>
//       )}
//     </>
